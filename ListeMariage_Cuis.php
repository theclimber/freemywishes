            ...
            <div id="templatemo_main_content_column">
              <div class="section_w600">
				...
				<table border="1" style="width:100%;">
					<form method="post" action="MerciOK.php" onSubmit="return verif_Commande();">
					...
					<?php
						try
						{
							...
							$reponse = $bdd->query('SELECT * FROM liste');										// Get content of table
							...
							?>
								<tr height="60px">
									<td align="center">
										<strong>
											<a class="highslide" onclick='return hs.expand(this, {captionText: "<?php echo $ItemDsc[$id] ?>"})' href="images/Cuisine/<?php echo $PhotoLnk ?>" target="_blank" title="<?php echo $ItemDsc[$id] ?>">
												<img src="images/Cuisine/<?php echo $PhotoLnk ?>" width="60">
											</a>
										</strong>
									</td>
									<td align="center">
